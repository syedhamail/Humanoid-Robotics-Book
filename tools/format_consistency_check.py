...
"""
Format Consistency Check for Humanoid Robotics Book
...
class FormatConsistencyChecker:
    ...
    def __init__(self, book_root: str = "/mnt/c/Users/saad/Desktop/quickbook-hackathon/my-humanoid-robotics-book"):
        ...
        self.docs_directory = self.book_root / "website" / "docs"
    ...
    def scan_all_chapters(self) -> List[Path]:
        ...
        for mdx_file in self.docs_directory.rglob("*.mdx"):
    ...
    def print_detailed_report(self, report: Dict[str, any]):
        ...
        """
        print("\n" + "="*80)
        print("BOOK FORMAT CONSISTENCY REPORT")
        print("="*80)
...
def main():
    ...
    """
    print("Running Book Format Consistency Checker...")
